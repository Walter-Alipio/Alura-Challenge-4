...
export default function Home(){
  ...
  return (
    <main className="h-full overflow-hidden">
      ...
      <section 
        className="h-full pt-24 overflow-scroll md:pt-56 lg:pt-24 flex flex-col items-center lg:h-full lg:bg-forma2 lg:bg-no-repeat lg:bg-right lg:bg-[length:134.45px_664px]"
      >
